...
<html>
	<head>
		<meta charset="utf-8">
		<title>Delivery pizza and sushi</title>
	...
	<div class="title3">
		...
		<div id="add-student"><button class="button button-primary" style="background-color: #fff; color: #000; font-size: 20px;">Вход</button></div></div></div></div>
			...
			<div class="cart">
				<div class="content">
					<div class="green">
						<div class="c1"><a href="">Your cart</a></div>
						<div class="c2"><a href="">Order something</a></div>
					</div>
					<div class="table">
						<table>
							<tr>
...
<?php }} ?>
				...
				<div class="zakaz">
					...
					<div class="pokupka">
						...
						<button class="order" class="button_c">Pay order</button>
					</div>
				</div>
				</div>
