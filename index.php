	...
	<section class="hero">
		<header>
			...
			<section class="caption">
				<h2 class="caption">Свадьба мечты это реально!</h2>
				<h3 class="properties">Организация свадеб по вашему желанию</h3><br>
				<h3>• быстрая организация дня ее свадьбы<br>
					• легко выбрать то, что они хотят<br>
					• сэкономить время<br>
					• лучший сервис</h3>
			</section>
	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<li>
					<a href="#">
						<img src="img/ex.jpg" alt="" title="" class="property_img"/>
					</a>
				...
				<li>
					<a href="#">
						<img src="img/ex1.jpg" alt="" title="" class="property_img"/>
					</a>
